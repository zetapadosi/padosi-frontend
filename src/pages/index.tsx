...
export default function Home() {
  return (
    <>
      <div className="h-full pt-[15vh] lg:pt-64 mx-auto max-w-6xl px-5 flex flex-col lg:flex-row gap-y-9 lg:gap-x-28 lg:justify-center items-center lg:items-start">
        ...
        <div className="w-11/12 z-10 max-w-sm flex flex-col gap-y-6">
          ...
          <Button color="secondary">Log in with Google</Button>
        </div>
        <div className="absolute -bottom-0 h-[35vh] w-[70vw]">
